...
async function getDATA(country_selected) {
    ...
    document.getElementById('main-title').textContent = "You have a " + percent.toFixed(2) + "% chance of getting COVID-19 in " + result;
    document.getElementById('Fact2').textContent = "Join " + hospitalizations + " other people in hospitals near you if you get COVID-19";
    if (deaths == 1) {
        document.getElementById('Fact3').textContent = deaths + " person has already died in " + result;
    } else {
        document.getElementById('Fact3').textContent = deaths + " people have already died in " + result;
    }
